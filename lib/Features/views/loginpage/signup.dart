...
class _SignUpPageState extends State<SignUpPage> {
  ...
  void initState() {
    super.initState();
    futureAlbum = fetchDataWithoutAPI();
  }
  ...
  Future<Autogenerated> fetchDataWithoutAPI() async {
      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: FutureBuilder<Autogenerated>(
            future: futureAlbum, // Future from initState
            builder: (context, snapshot) {
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                // You can use snapshot.data to display fetched data if needed
                return Column(
